...
module.exports = {
  ...
  onChat: async ({ api, event, args, message }) => {
    ...
    if (!question) {
      ...
      return message.reply("𝐡𝐨𝐰 𝐜𝐚𝐧 𝐈 𝐛𝐞 𝐨𝐟 𝐡𝐞𝐥𝐩 𝐭𝐨 𝐲𝐨𝐮 𝐭𝐨𝐝𝐚𝐲 🥷🩸");
    ...
    try {
      ...
      const replyMessage = await message.reply(`✰......𝗡𝗜𝗡𝗝𝗔𝗚𝗢.......✰: 🥷 \n⧠⧠⧠⧠⧠.✰.✰.⧠⧠⧠⧠⧠\n\n${answer}. 🥷🩸\n\n╰┈┈┈➤⊹⊱✰✫✫✰⊰⊹\n`);
  ...
  onReply: async ({ api, event, Reply, message }) => {
    ...
    try {
      ...
      const followUpMessage = await message.reply(`✰......𝗡𝗜𝗡𝗝𝗔𝗚𝗢.......✰: 🥷 \n⧠⧠⧠⧠⧠.✰.✰.⧠⧠⧠⧠⧠\n\n${answer}. 🥷🩸\n\n╰┈┈┈➤⊹⊱✰✫✫✰⊰⊹\n`);
